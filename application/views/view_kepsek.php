...
<head>
    ...
    <title>KEPSEK SMK IX LURAH 2</title>
<style type="text/css">
    a {
    color: #003399;
...
<body>
   <div id="preloader">
    ...
    <div id="wrapper">
        ...
        <nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
            <div class="navbar-header">
                ...
                CPANEL KEPALA SEKOLAH SMK9LURAH2 KOTA JAMBI </b>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
             &nbsp;&nbsp;
             &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
             &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
             &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            ...
            <div class="navbar-default sidebar" role="navigation">
                <div class="sidebar-nav navbar-collapse">
                    <ul class="nav" id="side-menu">
                        ...
                        <li>
                            <a href="index.php/kepsek"><i class="fa fa-dashboard fa-fw"></i> Home</a>
                        </li>
                         ...
                         <li>
                            ...
                            <li>
                                    <a href="index.php/kepsek/table_siswa">Tabel Siswa</a>
                                </li>

                                <li>
                                    <a href="index.php/kepsek/table_walikelas">Table Walikelas</a>
                                </li>
                                
                                <li>
                                    <a href="index.php/kepsek/table_guru">Table Data guru</a>
                                </li>
                                        
                                    <li>
                                    <a href="index.php/kepsek/table_nilai">Daftar Nilai</a>
                                </li>
                            </ul>
                            <!-- /.nav-second-level -->
                        </li>
                         ...
                         <li>
                            ...
                            <ul class="nav nav-second-level">
                            <li>
                                    <a href="index.php/kepsek/laporan_siswa">Laporan Nilai Siswa</a>
                                </li>

                                <li>
                                    <a href="index.php/kepsek/laporan_daftar_guru">Laporan Daftar Guru</a>
                                </li>
                                
                                <li>
                                    <a href="index.php/kepsek/laporan_daftar_siswa">Laporan Daftar Siswa</a>
                                </li>
                            </ul>
                            <!-- /.nav-second-level -->
                        </li><!-- 
                        <li>
                         ...
                         <li>
                            <a href="index.php/kepsek/pendaftaran"><i class="fa fa-bar-chart-o fa-fw"></i> Pendaftaran</a>
                        </li>
                           <li>
                            <a href="index.php/kepsek/seting_admin"><i class="fa fa-wrench fa-fw"></i> Setting</a>
                        </li>
                             <li>
    ...
    <p style="color:#777">
                   &nbsp;   &copy; 2016 SMK9LURAH 2 KOTA JAMBI <br/>
