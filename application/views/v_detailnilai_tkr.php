<?php 
 ...
 <div class="box">
                <div class="box-header">
                  <h3 class="box-title">Data Nilai Siswa IPA</h3>
                </div><!-- /.box-header -->
                <div class="box-body">
                  <table id="example1" class="table table-bordered table-striped">
                    ...
                    foreach ($data->result() as $row) {
                      ...
                      ?>
                        ...
                        <td>
                        <a href="<?php echo base_url() ?>index.php/from_walikelas_tkr/edit_nilai/<?php echo $row->id_pel ?>">Edit</a>

                        <a href="<?php echo base_url() ?>index.php/from_walikelas_tkr/hapus_nilai/<?php echo $row->id_pel ?>">Hapus</a>
