<?php echo form_open('super_admin/proses_editguru') ?>
...
<?php 
  $sss = "SELECT * FROM tbl_guru where nip='$nip'";
...
<div class="tab-pane active" id="biodata">
  ...
  <td>
        <div class='col-sm-2'><input type='text' value="<?php echo $edit->nip; ?>" name='nip' placeholder='No. Induk ..' class='form-control' required='required' value='' ></div>             
                                   <div class='col-sm-8'><input type='text' value="<?php echo $edit->nama_guru; ?>" name='nama_guru' placeholder='Nama ..' class='form-control' required='required' value='' ></div>                        
...
<tr><td>Bidang Study</td>
          <td>
              <div class="col-md-4">
              <input type='text' value="<?php echo $edit->bidang_study; ?>" name='bidang_study' placeholder='bidang study ..' class='form-control'  value='' >
       </div></tr>
        <tr>
