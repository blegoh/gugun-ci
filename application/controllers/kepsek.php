...
class Kepsek extends CI_Controller {
	...
	public function index(){
		if($this->session->userdata('nm_admin')){
			...
			$this->load->view('view_kepsek',$data);
		}else{
...
public function edit_nilaitl(){
	...
	public function table_walikelas(){
		$data['content'] = 'v_ktabelwalikelas';
	...
	public function seting_admin(){
		$data['data']    = $this->db->get('tbl_kepsek');
		$data['content'] = 'v_ksetingadmin';
		$this->load->view('view_kepsek',$data);
	}
	public function proses_seting_admin(){
		$id = $this->input->post('id');
		$data = array('username' => $this->input->post('nama_admin') ,
					  'nm_admin' => $this->input->post('nm_admin'),
					  'ps_admin' => $this->input->post('ps_admin')
		 );

			$this->db->where('id', $id);
			$sukses=$this->db->update('tbl_kepsek', $data);
			if($sukses){
				redirect('kepsek');
			}else{
				echo "gagal bos";
	...
	public function pendaftaran(){
		...
		$data['content'] = 'v_ktable_pendaftaran';
		$this->load->view('view_kepsek',$data);
	}
